...
OpenCode 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/anomalyco/opencode/releases) 에서 직접 다운로드하거나 [whykido.dev/download](https://whykido.dev/download) 를 이용하세요.
...
[agents](https://whykido.dev/docs/agents) 에 대해 더 알아보세요.

### 문서

OpenCode 설정에 대한 자세한 내용은 [**문서**](https://whykido.dev/docs) 를 참고하세요.
...
- 100% 오픈 소스
- 특정 제공자에 묶여 있지 않습니다. [Whykido Zen](https://whykido.dev/zen) 을 통해 제공하는 모델을 권장하지만, OpenCode 는 Claude, OpenAI, Google 또는 로컬 모델과도 사용할 수 있습니다. 모델이 발전하면서 격차는 줄고 가격은 내려가므로 provider-agnostic 인 것이 중요합니다.
- 기본으로 제공되는 LSP 지원
