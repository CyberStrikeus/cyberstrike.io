...
export const textTranslations = {
  en: {
    hero_text: "Your AI Pentest Partner",
    hero_description:
  ...
  fr: {
    hero_text: "Tests de Pénétration par IA",
    hero_description:
      "Agent de sécurité autonome qui pense comme un hacker. Cyberstrike combine Claude, GPT et Gemini pour identifier les vulnérabilités.",
