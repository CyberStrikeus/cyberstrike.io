...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/cyberstrike/cyberstrike/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for cyberstrike/cyberstrike...\n")
...
console.log("Fetching npm all-time downloads for cyberstrike...\n")
const npmDownloads = await fetchNpmDownloads("cyberstrike")
