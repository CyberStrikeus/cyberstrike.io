...
{/* TODO: Screenshot - Local MCP server configuration */}
<div className="border-2 border-dashed border-gray-400 dark:border-gray-600 rounded-lg p-8 my-6 text-center bg-gray-100 dark:bg-gray-800">
  ...
  <p className="text-gray-400 dark:text-gray-500 text-xs mt-2">Local MCP server configuration</p>
</div>
...
- [Remote Servers](/docs/mcp/remote-servers) - Remote MCP
