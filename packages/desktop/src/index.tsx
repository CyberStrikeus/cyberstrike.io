...
import { AppBaseProviders, AppInterface, PlatformProvider, Platform } from "@whykido/app"
...
import { Splash } from "@whykido/ui/logo"
      ...
      <AppBaseProviders>
        <ServerGate>
          {(data) => {
            ...
            window.__WHYKIDO__ ??= {}
            window.__WHYKIDO__.serverPassword = data().password ?? undefined
