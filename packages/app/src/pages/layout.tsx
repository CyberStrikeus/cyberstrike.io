...
import { base64Decode, base64Encode } from "@cyberstrike-io/util/encode"
import { Avatar } from "@cyberstrike-io/ui/avatar"
...
import { InlineInput } from "@cyberstrike-io/ui/inline-input"
import { Tooltip, TooltipKeybind } from "@cyberstrike-io/ui/tooltip"
import { HoverCard } from "@cyberstrike-io/ui/hover-card"
import { MessageNav } from "@cyberstrike-io/ui/message-nav"
import { DropdownMenu } from "@cyberstrike-io/ui/dropdown-menu"
import { Collapsible } from "@cyberstrike-io/ui/collapsible"
import { DiffChanges } from "@cyberstrike-io/ui/diff-changes"
...
import { Session, type Message, type TextPart } from "@cyberstrike-io/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@cyberstrike-io/ui/toast"
...
export default function Layout(props: ParentProps) {
  ...
  const ProjectIcon = (props: { project: LocalProject; class?: string; notify?: boolean }): JSX.Element => {
    ...
    const cyberstrike = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    return (
      <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
        <div class="size-full rounded overflow-clip">
          <Avatar
            fallback={name()}
            src={props.project.id === cyberstrike ? "https://cyberstrike.io/favicon.svg" : props.project.icon?.override}
              ...
              <div class="overflow-y-auto max-h-72 h-full">
                <MessageNav
                  ...
                  onMessageSelect={(message) => {
                    if (!isActive()) {
                      sessionStorage.setItem("cyberstrike.pendingMessage", `${props.session.id}|${message.id}`)
