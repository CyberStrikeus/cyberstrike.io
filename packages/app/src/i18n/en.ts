export const dict = {
  ...
  "dialog.provider.cyberstrike.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Cyberstrike",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Cyberstrike.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Cyberstrike.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Cyberstrike.",
  ...
  "dialog.server.description": "Switch which Cyberstrike server this app connects to.",
  ...
  "toast.update.description": "A new version of Cyberstrike ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Cyberstrike team",
  ...
  "error.chain.checkConfig": "Check your config (cyberstrike.jsonc) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Cyberstrike does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Cyberstrike includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for Cyberstrike",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Cyberstrike looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Cyberstrike is themed.",
