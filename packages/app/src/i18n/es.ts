export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Cyberstrike",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Cyberstrike.",
  ...
  "provider.connect.cyberstrikeArsenal.line1":
    "Cyberstrike Arsenal te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.cyberstrikeArsenal.visit.prefix": "Visita ",
  "provider.connect.cyberstrikeArsenal.visit.link": "cyberstrike.io/arsenal",
  "provider.connect.cyberstrikeArsenal.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Cyberstrike.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Cyberstrike.",
  ...
  "dialog.plugins.empty": "Plugins configurados en cyberstrike.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Cyberstrike se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Cyberstrike ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Cyberstrike",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Cyberstrike no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Cyberstrike incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Cyberstrike",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Cyberstrike en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Cyberstrike.",
