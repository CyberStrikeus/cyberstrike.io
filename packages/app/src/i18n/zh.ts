...
export const dict = {
  ...
  "provider.connect.whykidoZen.line1": "Whykido Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.whykidoZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.whykidoZen.visit.prefix": "访问 ",
  "provider.connect.whykidoZen.visit.link": "whykido.dev/zen",
  "provider.connect.whykidoZen.visit.suffix": " 获取你的 API 密钥。",
  ...
  "error.chain.checkConfig": "请检查你的配置 (whykido.jsonc) 中的 provider/model 名称",
