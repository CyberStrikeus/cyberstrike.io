export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Cyberstrike",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Cyberstrike.",
  ...
  "provider.connect.cyberstrikeArsenal.line1":
    "Cyberstrike Arsenal daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.cyberstrikeArsenal.visit.prefix": "Odwiedź ",
  "provider.connect.cyberstrikeArsenal.visit.link": "cyberstrike.io/arsenal",
  "provider.connect.cyberstrikeArsenal.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Cyberstrike.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Cyberstrike.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w cyberstrike.json",
  ...
  "dialog.server.description": "Przełącz serwer Cyberstrike, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Cyberstrike ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Cyberstrike",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (cyberstrike.jsonc) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, Cyberstrike nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "Cyberstrike zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Cyberstrike",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Cyberstrike na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Cyberstrike.",
