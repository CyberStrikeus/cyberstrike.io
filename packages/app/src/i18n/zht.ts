...
export const dict = {
  ...
  "provider.connect.whykidoZen.line1": "Whykido Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.whykidoZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.whykidoZen.visit.prefix": "造訪 ",
  "provider.connect.whykidoZen.visit.link": "whykido.dev/zen",
  "provider.connect.whykidoZen.visit.suffix": " 取得你的 API 金鑰。",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (whykido.jsonc) 中的 provider/model 名稱",
