...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Cyberstrike",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Cyberstrike.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Cyberstrike.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Cyberstrike.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i cyberstrike.json",
  ...
  "dialog.server.description": "Bytt hvilken Cyberstrike-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Cyberstrike ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Cyberstrike-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (cyberstrike.jsonc)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Cyberstrike ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Cyberstrike inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Cyberstrike",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Cyberstrike ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Cyberstrike er tematisert.",
