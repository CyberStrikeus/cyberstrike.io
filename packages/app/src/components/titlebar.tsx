...
import { TooltipKeybind } from "@cyberstrike-io/ui/tooltip"
import { useTheme } from "@cyberstrike-io/ui/theme"
  ...
  return (
    <header class="h-10 shrink-0 bg-background-base flex items-center relative" data-tauri-drag-region>
      ...
      >
        ...
        <div id="cyberstrike-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" data-tauri-drag-region />
        <div class="flex-1 h-full" data-tauri-drag-region />
        <div
          id="cyberstrike-titlebar-right"
      ...
      <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div id="cyberstrike-titlebar-center" class="pointer-events-auto" />
      </div>
    </header>
  )
}
