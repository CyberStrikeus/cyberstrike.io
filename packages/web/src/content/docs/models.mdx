...
Here the full ID is `provider_id/model_id`. For example, if you're using [Cyberstrike Zen](/docs/zen), you would use `cyberstrike/gpt-5.1-codex` for GPT 5.1 Codex.
