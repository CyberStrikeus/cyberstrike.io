...
The model ID in your Cyberstrike config uses the format `provider/model-id`. For example, if you're using [Cyberstrike Zen](/docs/zen), you would use `cyberstrike/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Do you have an agent you'd like to share? [Submit a PR](https://github.com/cyberstrike/cyberstrike).
:::
