...
description: What's new in Cyberstrike 1.0.
---

Cyberstrike 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same cyberstrike server.
...
version. However some older versions of Cyberstrike always grab latest.

To upgrade manually, run

```bash
$ cyberstrike upgrade 1.0.0
```

To downgrade back to 0.x, run

```bash
$ cyberstrike upgrade 0.15.31
```
