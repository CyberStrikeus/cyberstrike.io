...
description: What's new in Whykido 1.0.
---

Whykido 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same whykido server.
...
version. However some older versions of Whykido always grab latest.

To upgrade manually, run

```bash
$ whykido upgrade 1.0.0
```

To downgrade back to 0.x, run

```bash
$ whykido upgrade 0.15.31
```
