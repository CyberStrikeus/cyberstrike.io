---
title: TUI
description: Using the Cyberstrike terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Cyberstrike provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Cyberstrike starts the TUI for the current directory.
...
When using the Cyberstrike TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Cyberstrike. Allows you to select from available providers and add their API keys.
...
Exit Cyberstrike. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your Cyberstrike config file.
