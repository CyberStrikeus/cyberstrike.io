---
title: TUI
description: Using the Whykido terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Whykido provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Whykido starts the TUI for the current directory.
...
When using the Whykido TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Whykido. Allows you to select from available providers and add their API keys.
...
You can customize TUI behavior through your Whykido config file.
