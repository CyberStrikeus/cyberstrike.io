---
title: IDE
description: The Whykido extension for VS Code, Cursor, and other IDEs
---

Whykido integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `whykido` in the terminal to get started.
...
To install Whykido on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `whykido` - the extension installs automatically
...
Search for **Whykido** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `whykido` in the integrated terminal.
