---
title: IDE
description: The Cyberstrike extension for VS Code, Cursor, and other IDEs
---

Cyberstrike integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `cyberstrike` in the terminal to get started.
...
To install Cyberstrike on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `cyberstrike` - the extension installs automatically
...
Search for **Cyberstrike** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `cyberstrike` in the integrated terminal.
