---
title: Share
description: Share your Whykido conversations.
---

Whykido's share feature allows you to create public links to your Whykido conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Whykido:
...
Whykido supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Whykido uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `whykido.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using whykido in your organization.
