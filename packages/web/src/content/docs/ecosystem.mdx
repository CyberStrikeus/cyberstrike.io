...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track Cyberstrike usage with Wakatime                                                             |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for Cyberstrike sessions                                   |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on Cyberstrike context                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow Cyberstrike agents to lazy load prompts on demand with skill discovery and injection        |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for Cyberstrike – know when tasks complete                                |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for Cyberstrike                                                       |
...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building Cyberstrike plugins                           |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend for cyberstrike - a terminal-based AI coding agent  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using Cyberstrike via @cyberstrike/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for Cyberstrike             |
| [Cyberstrike-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embedds Cyberstrike in Obsidian's UI           |
