...
Create `.cyberstrike/commands/test.md`:

```md title=".cyberstrike/commands/test.md"
---
...
You can add custom commands through the Cyberstrike config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Cyberstrike [config](/docs/config):

```json title="cyberstrike.jsonc" {4-12}
{
...
- Global: `~/.config/cyberstrike/commands/`
- Per-project: `.cyberstrike/commands/`

```markdown title="~/.config/cyberstrike/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".cyberstrike/commands/component.md"
---
...
```md title=".cyberstrike/commands/create-file.md"
---
...
```md title=".cyberstrike/commands/analyze-coverage.md"
---
...
```md title=".cyberstrike/commands/review-changes.md"
---
...
```md title=".cyberstrike/commands/review-component.md"
---
...
cyberstrike includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
