...
Create `.whykido/commands/test.md`:

```md title=".whykido/commands/test.md"
---
...
You can add custom commands through the Whykido config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Whykido [config](/docs/config):

```json title="whykido.jsonc" {4-12}
{
...
- Global: `~/.config/whykido/commands/`
- Per-project: `.whykido/commands/`

```markdown title="~/.config/whykido/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".whykido/commands/component.md"
---
...
```md title=".whykido/commands/create-file.md"
---
...
```md title=".whykido/commands/analyze-coverage.md"
---
...
```md title=".whykido/commands/review-changes.md"
---
...
```md title=".whykido/commands/review-component.md"
---
...
whykido includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
