...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at whykido.ai",
  ...
  "Create {highlight}whykido.json{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/whykido/whykido.json{/highlight} for global config",
  ...
  "whykido auto-handles OAuth for remote MCP servers requiring auth",
  "Add {highlight}.md{/highlight} files to {highlight}.whykido/command/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.whykido/agent/{/highlight} for specialized AI personas",
  "Configure per-agent permissions for {highlight}edit{/highlight}, {highlight}bash{/highlight}, and {highlight}webfetch{/highlight} tools",
  'Use patterns like {highlight}"git *": "allow"{/highlight} for granular bash permissions',
  'Set {highlight}"rm -rf *": "deny"{/highlight} to block destructive commands',
  'Configure {highlight}"git push": "ask"{/highlight} to require approval before pushing',
  "whykido auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "whykido uses LSP servers for intelligent code analysis",
  "Create {highlight}.ts{/highlight} files in {highlight}.whykido/tool/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.whykido/plugin/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent whykido from reading sensitive files",
  "Use {highlight}whykido run{/highlight} for non-interactive scripting",
  "Use {highlight}whykido --continue{/highlight} to resume the last session",
  "Use {highlight}whykido run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}whykido serve{/highlight} for headless API access to whykido",
  "Use {highlight}whykido run --attach{/highlight} to connect to a running server",
  "Run {highlight}whykido upgrade{/highlight} to update to the latest version",
  "Run {highlight}whykido auth list{/highlight} to see all configured providers",
  "Run {highlight}whykido agent create{/highlight} for guided agent creation",
  "Use {highlight}/whykido{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}whykido github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/whykido fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/oc{/highlight} on PR code lines for targeted code reviews",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in {highlight}.whykido/themes/{/highlight} directory",
  ...
  "Run {highlight}whykido debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/whykido{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with whykido Zen for curated, tested models",
