...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders WHYKIDO_CALLER", () => {
    process.env["WHYKIDO_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode WHYKIDO_CALLER", () => {
    process.env["WHYKIDO_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown WHYKIDO_CALLER", () => {
    process.env["WHYKIDO_CALLER"] = "unknown"
