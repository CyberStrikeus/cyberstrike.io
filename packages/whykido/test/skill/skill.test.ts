...
test("discovers skills from .whykido/skill/ directory", async () => {
...
test("discovers multiple skills from .whykido/skill/ directory", async () => {
  await using tmp = await tmpdir({
    git: true,
    init: async (dir) => {
...
test("discovers global skills from ~/.claude/skills/ directory", async () => {
  ...
  const originalHome = process.env.WHYKIDO_TEST_HOME
  process.env.WHYKIDO_TEST_HOME = tmp.path
  ...
  try {
    ...
    process.env.WHYKIDO_TEST_HOME = originalHome
  }
})
