...
import video from "../asset/lander/cyberstrike-min.mp4"
import videoPoster from "../asset/lander/cyberstrike-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="cyberstrike">
      {/*<HttpHeader name="Cache-Control" value="public, max-age=1, s-maxage=3600, stale-while-revalidate=86400" />*/}
      <Title>Cyberstrike | The open source AI coding agent</Title>
        ...
        <div data-component="content">
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">cyberstrike</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">cyberstrike/tap/cyberstrike</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
          ...
          <section data-component="what">
            <div data-slot="section-title">
              <h3>What is Cyberstrike?</h3>
              <p>Cyberstrike is an open source agent that helps you write code in your terminal, IDE, or desktop.</p>
            </div>
            <ul>
              <li>
                <span>[*]</span>
            ...
            <div data-slot="section-title">
              ...
              <div>
                ...
                <p>
                  ...
                  <strong>{config.stats.commits}</strong> commits, Cyberstrike is used and trusted by over{" "}
          ...
          <section data-component="privacy">
            <div data-slot="privacy-title">
              ...
              <div>
                ...
                <p>
                  Cyberstrike does not store any of your code or context data, so that it can operate in privacy sensitive
            ...
            <ul>
              <li>
                <Faq question="What is Cyberstrike?">
                  Cyberstrike is an open source agent that helps you write and run code with any AI model. It's available
              ...
              <li>
                <Faq question="Can I use my existing AI subscriptions with Cyberstrike?">
                  Yes, Cyberstrike supports subscription plans from all major providers. You can use your Claude Pro/Max,
              ...
              <li>
                <Faq question="How much does Cyberstrike cost?">
                  Cyberstrike is 100% free to use. It also comes with a set of free models. There might be additional costs
