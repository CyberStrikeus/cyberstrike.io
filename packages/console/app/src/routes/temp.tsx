...
export default function Home() {
  ...
  return (
    <main data-page="home">
      <Title>cyberstrike | AI coding agent built for the terminal</Title>
      ...
      <div data-component="content">
        ...
        <section data-component="install">
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                npm install -g <strong>cyberstrike</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                bun install -g <strong>cyberstrike</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
        ...
        <section data-component="screenshots">
          <figure>
            <figcaption>cyberstrike TUI with the tokyonight theme</figcaption>
            <a href="/docs/cli">
              <img src={IMG_SPLASH} alt="cyberstrike TUI with tokyonight theme" />
            </a>
          </figure>
        </section>
