...
export const InviteEmail = ({
  ...
  return (
    <Html lang="en">
      <Head>
        <Title>{`Cyberstrike — ${messagePlain}`}</Title>
      </Head>
        ...
        <Container style={container}>
          <Section style={frame}>
            ...
            <Section style={{ padding: `${unit * 2}px 0 0 0` }}>
              <Text style={headingText}>Join your team's Cyberstrike workspace</Text>
              <Text style={contentText}>
                You have been invited by <Span style={contentHighlightText}>{inviter}</Span> to join the{" "}
                <Span style={contentHighlightText}>{workspaceName}</Span> workspace on Cyberstrike.
              </Text>
            </Section>
