...
const TIPS = [
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/cyberstrike{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with cyberstrike Zen for curated, tested models",
