...
function App() {
  ...
  command.register(() => [
    ...
    },
    {
      ...
      value: "docs.open",
      onSelect: () => {
        open("https://cyberstrike.io/docs").catch(() => {})
        dialog.clear()
      },
      category: "System",
    },
  ...
  return (
    <box
      ...
      onMouseUp={async () => {
        if (Flag.CYBERSTRIKE_EXPERIMENTAL_DISABLE_COPY_ON_SELECT) {
          renderer.clearSelection()
          return
        }
...
function ErrorComponent(props: {
  ...
  issueURL.searchParams.set("cyberstrike-version", Installation.VERSION)
